...
public static class SeedData
{
    public static async Task SeedAsync(IServiceProvider services)
    {
        ...
        try
        {
            ...
            await SeedCatalog(services, logger);
        }
        catch (Exception ex)
        {
    ...
    private static async Task SeedCatalog(IServiceProvider services, ILogger logger)
    {
        ...
        logger.LogInformation("Catalog seeded: {Categories} categories, {Products} products",
            4, await context.Products.CountAsync());
    }
}
